...
def specify_suffix_and_dictionary():
    ...
    domain_dictionary = input("输入字典名(如:lzm.txt)____:")
    domain_name_length = 7
...
def specify_the_domain_name():
    domain_name = input("输入想要的域名(如bt.mba只输入bt)____:")
